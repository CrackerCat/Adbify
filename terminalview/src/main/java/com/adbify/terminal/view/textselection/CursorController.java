package com.adbify.terminal.view.textselection;
...
/**
 * A CursorController instance can be used to control cursors in the text. It is not used outside of
 * {@link TerminalView}.
 */
public interface CursorController extends ViewTreeObserver.OnTouchModeChangeListener {
    /**
     * Show the cursors on screen. Will be drawn by {@link #render()} by a call during onDraw. See
     * also {@link #hide()}.
     */
    void show(MotionEvent event);

    /**
     * Hide the cursors from screen. See also {@link #show(MotionEvent event)}.
     */
    boolean hide();
    ...
    /**
     * This method is called by {@link #onTouchEvent(MotionEvent)} and gives the cursors a chance to
     * become active and/or visible.
     *
