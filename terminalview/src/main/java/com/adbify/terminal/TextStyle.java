...
public final class TextStyle {
    ...
    /**
     * The selective erase control functions (DECSED and DECSEL) can only erase characters defined
     * as erasable.
     *
    ...
    /**
     * The 256 standard color entries and the three special (foreground, background and cursor)
     * ones.
     */
