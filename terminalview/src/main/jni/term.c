...
#define ADBIFY_UNUSED(x) x __attribute__((__unused__))
#ifdef __APPLE__
...
JNIEXPORT jint JNICALL Java_com_adbify_terminal_JNI_createSubprocess(
        JNIEnv *env,
        jclass ADBIFY_UNUSED(clazz),
        jstring cmd,
        jstring cwd,
        jobjectArray args,
...
JNIEXPORT void JNICALL Java_com_adbify_terminal_JNI_setPtyWindowSize(JNIEnv *ADBIFY_UNUSED(env),
                                                                     jclass ADBIFY_UNUSED(clazz),
                                                                     jint fd, jint rows,
                                                                     jint cols) {
...
Java_com_adbify_terminal_JNI_setPtyUTF8Mode(JNIEnv *ADBIFY_UNUSED(env), jclass ADBIFY_UNUSED(clazz),
                                            jint fd) {
    struct termios tios;
    tcgetattr(fd, &tios);
...
Java_com_adbify_terminal_JNI_waitFor(JNIEnv *ADBIFY_UNUSED(env), jclass ADBIFY_UNUSED(clazz),
                                     jint pid) {
    int status;
...
JNIEXPORT void JNICALL
Java_com_adbify_terminal_JNI_close(JNIEnv *ADBIFY_UNUSED(env), jclass ADBIFY_UNUSED(clazz),
                                   jint fileDescriptor) {
